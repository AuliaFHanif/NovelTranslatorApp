...
const Scene = require('./Scene')(sequelize, Sequelize.DataTypes);
const SceneDependency = require('./SceneDependency')(sequelize, Sequelize.DataTypes);
...
db.Chapter = Chapter;
db.Scene = Scene;
db.SceneDependency = SceneDependency;
